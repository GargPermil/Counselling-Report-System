...
namespace Counselling_Report_Generation_System
{
    public partial class Delete_Counselor : Form
    {
        ...
        {
            string cmdstr = "DELETE FROM COUNSELOR WHERE C_ID=@UID";
        ...
        private void Delete_Counselor_Load(object sender, EventArgs e)
        {
